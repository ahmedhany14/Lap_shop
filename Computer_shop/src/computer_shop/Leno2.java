 ...
 * @author ahmed hany
 */
public class Leno2 extends javax.swing.JFrame {

    /**
     * Creates new form Leno2
     */
    ...
    public Leno2() {
        ...
        try {
            ...
            while(res.next()){
                if(res.getInt(3) == 15 && res.getBoolean(6) == true && res.getString(2).equals(ob.username)){
                    save1.setSelected(true);  
                }
                if(res.getInt(3) == 16 && res.getBoolean(6) == true && res.getString(2).equals(ob.username)){
        ...
        if(is_avalap1 == true)avalap3.setText("Avalible");
        else avalap3.setText("Not Avalible");
        if(is_avalap2 == true)avalap2.setText("Avalible");
        else avalap2.setText("Not Avalible");
        Price1.setText("Price " + lenprice3 + " $");
        Price2.setText("Price " + lenprice4 + " $");
    }
    ...
    private void initComponents() {
        ...
        avalap3 = new javax.swing.JLabel();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ahmed hany\\OneDrive\\Desktop\\resized photos\\leno3.jpg")); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\ahmed hany\\OneDrive\\Desktop\\resized photos\\leno4.jpg")); // NOI18N
        ...
        Price1.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        Price1.setForeground(new java.awt.Color(255, 0, 51));
        Price1.setText("Price : ");

        avalap2.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        avalap2.setForeground(new java.awt.Color(255, 0, 51));
        avalap2.setText("Avalible : ");

        avalap3.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        avalap3.setForeground(new java.awt.Color(255, 0, 51));
        avalap3.setText("Avalible : ");

        Price2.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        Price2.setForeground(new java.awt.Color(255, 0, 51));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(Price1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addComponent(avalap3, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(avalap2, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Price2, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(53, 53, 53))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(avalap2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(avalap3, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(9, 9, 9)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try {
            ...
            int theopraion = 0 ;
            while(res.next()){
                 if(res.getInt(3) == 15 && res.getString(2).equals(ob.username)){
            ...
            if(theopraion == 0){ // insert
                ...
                stmt_for_check_user.setInt(2, 15);
                stmt_for_check_user.setInt(3, lenprice3);
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        ...
        try {
            ...
            int theopraion = 0 ;
            while(res.next()){
                 if(res.getInt(3) == 16 && res.getString(2).equals(ob.username)){
                    theopraion = res.getInt(1);
                    break;
                }
            }
            if(theopraion == 0){ // insert
                stmt_for_check_user = con.prepareStatement("insert into operation_table (user_name,lap_id,price,bought,saved) values(?,?,?,?,?)");
                stmt_for_check_user.setString(1, ob.username);
                stmt_for_check_user.setInt(2, 16);
                stmt_for_check_user.setInt(3, lenprice4);
                stmt_for_check_user.setBoolean(4, false);
                stmt_for_check_user.setBoolean(5, true);
                stmt_for_check_user.executeUpdate();
                save2.setSelected(true);
    ...
    private void Buy1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy1ActionPerformed
         if(is_avalap1){
            try {
                ...
                stmt_for_check_user.executeUpdate();
                JOptionPane.showMessageDialog(this, "Success , the cost is " + lenprice3);
                ...
                stmt_for_check_user.setInt(3, 15);
                stmt_for_check_user.executeUpdate();
                Quere = "update usertable set total = ? , lapcnt = ?  where username = ?";
                stmt_for_check_user = con.prepareStatement(Quere);
                stmt_for_check_user.setInt(1,totalprice + lenprice3);
                stmt_for_check_user.setInt(2,counterlaps1 + 1);
    ...
    private void Buy2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy2ActionPerformed
        if(is_avalap2){
            try {
                ...
                stmt_for_check_user.setInt(5, 0);
                stmt_for_check_user.executeUpdate();
                JOptionPane.showMessageDialog(this, "Success , the cost is " + lenprice4);
                String Quere = "update laptops set lap_counter = ? , saledcnt = ?  where lap_id = ?";
                stmt_for_check_user = con.prepareStatement(Quere);
                stmt_for_check_user.setInt(1,numberoflapsishere2 - 1);
                stmt_for_check_user.setInt(2,counterlaps2 + 1);
                stmt_for_check_user.setInt(3, 16);
                stmt_for_check_user.executeUpdate();
                Quere = "update usertable set total = ? , lapcnt = ?  where username = ?";
                stmt_for_check_user = con.prepareStatement(Quere);
                stmt_for_check_user.setInt(1,totalprice + lenprice4);
                stmt_for_check_user.setInt(2,counterlaps1 + 1);
                stmt_for_check_user.setString(3, ob.username);
                stmt_for_check_user.executeUpdate();
                this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leno2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel avalap3;
