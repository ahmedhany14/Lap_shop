 ...
 * @author ahmed hany
 */
public class Mac1 extends javax.swing.JFrame {

    /**
     * Creates new form Mac1
     */
    ...
    public Mac1() {
        ...
        try {
            ...
            while(res.next()){
                if(res.getInt(3) == 9 && res.getBoolean(6) == true && res.getString(2).equals(ob.username)){
                    save1.setSelected(true);  
                }
                if(res.getInt(3) == 10 && res.getBoolean(6) == true && res.getString(2).equals(ob.username)){
        ...
        if(is_avalap1 == true)avalab1.setText("Avalible");
        else avalab1.setText("Not Avalible");
        if(is_avalap2 == true)avalab2.setText("Avalible");
        else avalab2.setText("Not Avalible");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\ahmed hany\\OneDrive\\Desktop\\resized photos\\ma1.jpg")); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\ahmed hany\\OneDrive\\Desktop\\resized photos\\ma2.jpg")); // NOI18N
        ...
        avalab1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        avalab1.setForeground(new java.awt.Color(204, 0, 0));
        avalab1.setText("Avalible : ");

        Price1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Price1.setForeground(new java.awt.Color(204, 0, 0));
        Price1.setText("Price: ");

        avalab2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        avalab2.setForeground(new java.awt.Color(204, 0, 0));
        avalab2.setText("Avalible : ");

        Price2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Price2.setForeground(new java.awt.Color(204, 0, 0));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(avalab1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(Price1, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(avalab2, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Price2, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(53, 53, 53))
        );
    ...
    private void Buy1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy1ActionPerformed
        if(is_avalap1){
            try {
                ...
                stmt_for_check_user.setInt(2, 9);
                ...
                stmt_for_check_user.setInt(3, 9);
                stmt_for_check_user.executeUpdate();
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try {
            ...
            int theopraion = 0 ;
            while(res.next()){
                 if(res.getInt(3) == 9 && res.getString(2).equals(ob.username)){
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        ...
        try {
            ...
            if(theopraion == 0){ // insert
                stmt_for_check_user = con.prepareStatement("insert into operation_table (user_name,lap_id,price,bought,saved) values(?,?,?,?,?)");
                stmt_for_check_user.setString(1, ob.username);
                stmt_for_check_user.setInt(2, 10);
    ...
    private void Buy2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buy2ActionPerformed
        if(is_avalap2){
            try {
                ...
                stmt_for_check_user.setInt(3, 10);
                stmt_for_check_user.executeUpdate();
                Quere = "update usertable set total = ? , lapcnt = ?  where username = ?";
                stmt_for_check_user = con.prepareStatement(Quere);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mac1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
